...
data = data[:,:-1]  #this is equal to data <- data[,1:(ncol(data)-1)]
...
data=data[1:]
classifications=data[0:,1] #This is an array of the second column of the file, a text representation of the classification.
